	...
	<div>
		 <form method="post" action="addEmployee.do">
					<ul>
						 ...
						 <li><input type="text" name="emp_name" value=""></li>
					 </ul>
					 <ul>
						 <li class="text-info">雇员性别: </li>
						 <li>
						 	<input name="emp_sex" type="radio" value="1" />男
						 	<input name="emp_sex" type="radio" value="2" />女
						 </li>
					 </ul>				 
					<ul>
						 <li class="text-info">雇员年龄: </li>
						 <li><input type="text" name="emp_age" value=""></li>
					 </ul>
					 <ul>
						 <li class="text-info">所属部门: </li>
						 <li><input type="text" name="emp_depart" value=""></li>
					 </ul>
